...
import com.psia.pkoc.core.DisplayPublicKeyFragment;
...
public class MainActivity extends AppCompatActivity implements NfcAdapter.ReaderCallback {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        if (item.getItemId() == R.id.action_display_public_key)
        {
            ...
            fragmentTransaction.replace(R.id.mainLayout, new DisplayPublicKeyFragment());
...
// Parse the public key on the main thread
                    ...
                    byte[] responseTLV = TLVProvider.GetBleTLV(BLE_PacketType.Response, new byte[]{response});
